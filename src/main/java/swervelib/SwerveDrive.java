...
public class SwerveDrive
{
  ...
  public ChassisSpeeds getFieldVelocity()
  {
    ...
    ChassisSpeeds.fromRobotRelativeSpeeds(robotRelativeSpeeds, getOdometryHeading());//.unaryMinus());
  ...
  public void resetOdometry(Pose2d pose)
  {
    ...
    ChassisSpeeds.fromRobotRelativeSpeeds(robotRelativeSpeeds, getYaw());
...
//    resetOdometry(newOdometry);
  ...
  public ChassisSpeeds angularVelocitySkewCorrection(ChassisSpeeds robotRelativeVelocity)
  {
    ...
    if (angularVelocity.getRadians() != 0.0)
    {
      ...
      ChassisSpeeds.fromFieldRelativeSpeeds(robotRelativeVelocity, getOdometryHeading().plus(angularVelocity));
    }
                                              ...
                                              boolean useAngularVelocitySkewCorrection)
  {
    ...
    {
      return ChassisSpeeds.discretize(robotRelativeVelocity, discretizationdtSeconds);
    }
